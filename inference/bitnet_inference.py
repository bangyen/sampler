...
class BitNetInference:
    ...
    def __init__(
        self, model_path: str, n_ctx: int = 2048, n_threads: Optional[int] = None
    ):
        """
...
def download_gguf_model(
    hf_repo: str, filename: str = None, cache_dir: str = "./models"
) -> str:
    """
    ...
    model_path = hf_hub_download(
        repo_id=hf_repo, filename=filename, local_dir=local_dir
    )
